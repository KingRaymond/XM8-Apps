...
private["_display","_killDeathRatio","_killDeathRatioControl","_popTabsPlayer","_popTabsLocker","_popTabsValue","_popTabs","_respectValue","_respect"];
...
_popTabsPlayer = (player getVariable ["ExileMoney", 0]);
_popTabsLocker = (player getVariable ["ExileLocker", 0]);
_popTabsValue = _popTabsPlayer + _popTabsLocker;
